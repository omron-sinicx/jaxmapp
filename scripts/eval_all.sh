...
for dataset in eval_example eval_standard eval_wo_obs eval_many_obs eval_more_agents eval_hetero
do
...
for dataset in eval_example eval_standard eval_wo_obs eval_many_obs eval_more_agents 
do
...
for dataset in eval_example eval_standard eval_wo_obs eval_many_obs eval_more_agents 
do
for num_samples in 1024 4096 7056
do
echo "dataset: $dataset | num_samples: $num_samples"
